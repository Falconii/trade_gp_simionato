...
CREATE TABLE public.Nfe_Det_Trade  ( 
            ...
            boni_planilha  int4 NOT NULL default 0,
            boni_linha     int4 NOT NULL default 0,
...
DROP TABLE IF EXISTS Nfe_Det_Trade_5910;
CREATE TABLE public.Nfe_Det_Trade_5910  ( 
            id_grupo  int4 NOT NULL,
            id_planilha  int4 NOT NULL,
            id_operacao char(1) NOT NULL, 
            nro_linha  int4 NOT NULL,
            ...
            fator           numeric(06,2) NOT NULL ,
            etapa           int4          NOT NULL default 0,
			qtd_venda       numeric(15,04)NOT NULL default 0,
			venda_status    char(2)       NOT NULL default '',
 	PRIMARY KEY(id_grupo,id_planilha,nro_linha)
)
GO
CREATE INDEX indice_cfop_5910
	ON public.Nfe_Det_Trade_5910 USING btree (id_grupo int4_ops, cod_emp text_ops, local text_ops, id_operacao bpchar_ops, dt_ref date_ops, cfop bpchar_ops)
GO
CREATE INDEX indice_calculo_saldo_5910
	ON public.Nfe_Det_Trade_5910 USING btree (id_grupo int4_ops, cod_emp text_ops, local text_ops, dt_ref date_ops, status bpchar_ops, id_operacao bpchar_ops)
GO
CREATE INDEX indice_sai_dev_5910
	ON public.Nfe_Det_Trade_5910 USING btree (id_grupo int4_ops, id_operacao bpchar_ops, id_saida int4_ops, nro_linha_saida int4_ops)
GO
CREATE INDEX indice_dev_saida_5910
	ON public.Nfe_Det_Trade_5910 USING btree (id_grupo int4_ops, cod_emp text_ops, local text_ops, cfop bpchar_ops, id_operacao bpchar_ops, nro_doc text_ops, material text_ops)
GO
CREATE INDEX indice_dev_entrada_5910
	ON public.Nfe_Det_Trade_5910 USING btree (id_grupo int4_ops, cod_emp text_ops, local text_ops, id_operacao bpchar_ops, dt_ref date_ops)
GO



DROP TABLE IF EXISTS nfe_cab_trade_5910;
CREATE TABLE public.nfe_cab_trade_5910  ( 
	id_grupo          	int4 NOT NULL,
	id                	serial NOT NULL,
	arquivo          	varchar(200) NOT NULL,
	qtd               	numeric(15,4) NULL,
...
GO
CREATE INDEX nfe_cab_trade_arquivo_5910
	ON public.nfe_cab_trade_5910 USING btree (id_grupo int4_ops, arquivo bpchar_ops)
GO
