...
namespace Trade_GP
{
    public partial class FormSaldosLote : Form
    {
        ...
        public FormSaldosLote()
        {
            InitializeComponent();
        }

        private void FormSaldosLote_Load(object sender, EventArgs e)
        {
            btProximoFlag = false;
        ...
        private void FormSaldosLote_Activated(object sender, EventArgs e)
        {
            WindowState = System.Windows.Forms.FormWindowState.Maximized;
        }

        private void FormSaldosLote_FormClosed(object sender, FormClosedEventArgs e)
        {
            menu.Enabled = true;
        }
    ...
    private void LoadDbGridLocais()
        ...
        private async Task<int> contagem(int id_grupo, string cod_emp, string local)
        {
            ...
            foreach (meses mes in lsMeses)
            {
                ...
                try
                {
                    ...
                    _qtd_notas = await daoDet.Conta_Nfe_Saida_Saldos(UsuarioSistema.Id_Grupo, cod_emp, local, mes.Mes);
        ...
        private async Task<int> validacaoDevAsync()
        {
            ...
            FormAviso formAviso = new FormAviso("Analisando As Devoluções!");
        ...
        private async Task<int> LoadEscopo()
        {
            ...
            try
            {
                ...
                contadores = await dao.Conta_Nfe_Saida_SaldosByDay(1, Parametros[0].Cod_Emp, locais, periodos);
