...
{
    public class daoNfeCabTrade5910 
    {
        public NfeCabTrade5910 Insert(NfeCabTrade5910 obj)
        {
            String StringInsert = $" INSERT INTO nfe_cab_trade_5910(id_grupo,arquivo, qtd, vlr_contabil, bas_icms, vlr_icms, bas_pis, vlr_pis, bas_cof, vlr_cof, bas_ipi, vlr_ipi, bas_icms_st, vlr_icms_st, nro_linha, usuarioinclusao, usuarioatualizacao, data_criacao, data_fechamento, status, ultima, layout, resumo_5405) VALUES ( " +
            $"  {obj.Id_Grupo}    " +
            $",'{obj.Arquivo}'   " +
            ...
            Console.WriteLine($"Insert nfe_cab_trade_5910: {StringInsert}");
        ...
        public void Update(NfeCabTrade5910 obj)
        {

            String StringUpdate = $" UPDATE nfe_cab_trade_5910 SET " +
            $"    Arquivo                          = '{obj.Arquivo}'   " +
        ...
        public void Delete(NfeCabTrade5910 obj)
        {
            try
            {
                String StringDelete = $" DELETE FROM  nfe_cab_trade_5910  WHERE ID_GRUPO = {obj.Id_Grupo} AND ID = {obj.Id} ";
        ...
        public void DeleteAll(NfeCabTrade5910 obj)
        {
            try
            {
                String StringDelete = $" DELETE FROM  nfe_cab_trade_5910  WHERE ID_GRUPO = {obj.Id_Grupo} AND ID = {obj.Id} ";
        ...
        public NfeCabTrade5910 Seek(int id_grupo, int id)
        {

            NfeCabTrade5910 obj = null;

            string strStringConexao = DataBase.RunCommand.connectionString;

            string strSelect = $"SELECT * FROM nfe_cab_trade_5910 WHERE ID_GRUPO = {id_grupo} AND ID = {id}";
        ...
        public NfeCabTrade5910 SeekByPlanilha(int id_grupo, string Arquivo)
        {
            ...
            string strSelect = $"SELECT * FROM nfe_cab_trade_5910 WHERE ID_GRUPO = {id_grupo} and ARQUIVO  ='{Arquivo}' ";
        ...
        public NfeCabTrade5910 SeekByPlanilhaV2(int id_grupo, string Arquivo)
        {
        ...
        private NfeCabTrade5910 PopulaNfeCab(NpgsqlDataReader objDataReader)
        {

            var obj = new NfeCabTrade5910();
        ...
        private NfeCabTrade5910 PopulaNfeCabPobre(NpgsqlDataReader objDataReader)
        {
            var obj = new NfeCabTrade5910();
            obj.Id = Convert.ToInt32(objDataReader["id"].ToString());
            obj.Arquivo = objDataReader["arquivo"].ToString();
        ...
        public List<NfeCabTrade5910> getAll(int Ordenacao, string Filtro)
        {
            ...
            List<NfeCabTrade5910> lista = new List<NfeCabTrade5910>();
        ...
        private String SelectNfeCabPage(Filtro_NfeCabE Filtro, int Page, int TamPage, bool Contador)
        {
            ...
            if (Contador)
            {
                strSelect = "SELECT count(*) AS TOTAL FROM nfe_cab_trade_5910 CAB ";
